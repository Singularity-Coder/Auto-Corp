  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header className="flex justify-between items-end">
        ...
        <button 
          onClick={onDeploy}
          className="bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-xl shadow-slate-200 transition-transform active:scale-95 flex items-center gap-2"
        >
          <Plus size={18} />
          New Entity
        </button>
            ...
            >
              <div className="p-8">
                ...
                <div className="mt-8 flex items-center justify-between">
                   <span className="text-[10px] font-bold text-slate-300 uppercase">EST. {entity.incorporationDate ? new Date(entity.incorporationDate).toLocaleDateString() : 'N/A'}</span>
